...
export function BrowniePet({ mood = "happy", reacting = false, accessory = "basic-collar", className = "" }: BrowniePetProps) {
  ...
  return (
    <svg viewBox="0 0 260 240" className={`${reacting || excited ? "animate-dog-react" : ""} ${className}`} role="img" aria-label={`${mood} Brownie, a fluffy caramel poodoodle`}>
      <defs>
        <linearGradient id="brownie-coat" x1="74" y1="35" x2="183" y2="220" gradientUnits="userSpaceOnUse"><stop stopColor="#DCA36D" /><stop offset="1" stopColor="#B97543" /></linearGradient>
        <linearGradient id="brownie-muzzle" x1="105" y1="118" x2="155" y2="168" gradientUnits="userSpaceOnUse"><stop stopColor="#FFF0D5" /><stop offset="1" stopColor="#EAC79F" /></linearGradient>
        <filter id="brownie-shadow" x="-30%" y="-30%" width="160%" height="170%"><feDropShadow dx="0" dy="8" stdDeviation="7" floodColor="#5F3A25" floodOpacity=".17" /></filter>
      </defs>
      ...
      <g filter="url(#brownie-shadow)">
        ...
        <ellipse cx="132" cy="194" rx="58" ry="34" fill="url(#brownie-coat)" />
        ...
        <ellipse cx="131" cy="106" rx="66" ry="73" fill="url(#brownie-coat)" />
        ...
        <ellipse cx="131" cy="139" rx="42" ry="33" fill="url(#brownie-muzzle)" />
