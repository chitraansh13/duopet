...
export function ChallengesDashboard() {
  ...
  function createChallenge(challenge: Challenge) {
  ...
  const metrics = [
    ...
    { label: "Completed Together", value: togetherFinished.length },
