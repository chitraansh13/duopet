...
const heatmapScores: Array<[number, number]> = [
  ...
  [80, 60], [100, 80], [75, 70], [90, 90], [60, 65], [85, 80], [98, 92],
];
...
export const progressData = {
  ...
  streak: {
    current: 14,
    best: 23,
    recentDays: [true, true, true, true, true, true, true, true, true, true, true, true, true, true],
  },
  dailyCompletion: [
  ...
  heatmap: heatmapScores.map(([you, friend], index) => {
  ...
  habits: [
    ...
    { id: "calories", name: "Diet / Calories", icon: "calories", rates: { week: { overall: 69, you: 66, friend: 71 }, month: { overall: 73, you: 70, friend: 76 }, quarter: { overall: 71, you: 69, friend: 73 } } },
