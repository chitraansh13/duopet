...
export default function TodayPage() {
  ...
  const { profile,duo,runtime }=useSession();
  const { sharedGoals, yourGoals, youProgress, friendProgress, duoProgress, pairedGoals, perfectDay, pet } = deriveToday(goals, currentUserId, partnerUserId,runtime.companion);
